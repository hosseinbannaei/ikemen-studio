...
export function GetProjectAudio(arg1:string):Promise<Array<project.ProjectAudioInfo>>;

export function GetProjectFightersAndStages(arg1:string):Promise<main.ProjectFightersAndStages>;

export function GetProjectFonts(arg1:string):Promise<Array<project.ProjectFontInfo>>;

export function GetProjectLifebars(arg1:string):Promise<Array<project.ProjectLifebarInfo>>;

export function GetProjectLogs(arg1:string):Promise<string>;

export function GetProjectMotifs(arg1:string):Promise<Array<project.ProjectMotifInfo>>;

export function GetProjectRoster(arg1:string):Promise<project.ProjectRoster>;

export function GetProjectStages(arg1:string):Promise<Array<project.ProjectStageInfo>>;

export function GetProjectStoryboards(arg1:string):Promise<Array<project.ProjectStoryboardInfo>>;
